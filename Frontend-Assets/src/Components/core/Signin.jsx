...
import Sign_in from "../../assets/Sign_up.gif";
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(res.ok){
        ...
        console.log("set item done", data.AccessToken)
      }else{
    ...
    <div className="font-[sans-serif] text-[#333]">
      <div className="min-h-screen flex flex-col items-center justify-top">
        <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div className="md:h-full max-md:mt-10 rounded-xl lg:p-5 p-5">
            <img
              src={Sign_in}
          ...
          <div className="md:max-w-md w-full sm:px-6 py-2">
            <form onSubmit={handleSubmit} className="font-normal from-neutral-950">
              <div className="mb-12">
                ...
                <p className="text-sm mt-2 ">
                  ...
                  <Link
                    ...
                    className="text-[#8800ff] font-semibold ml-1 whitespace-nowrap hover:text-[#8200ff]"
                  >
                    Register here
                  </Link>
                </p>
              ...
              <div>
                <label className="text-m block mb-2">Email</label>
              ...
              <div className="flex items-center justify-between gap-2 mt-4">
                <div className="flex justify-center space-x-5 mb-2 font-normal">
                  <div className="flex items-center">
                    ...
                    />
                    <label for="remember-me" className="ml-3 block text-m">
                      Mentor
                    </label>
                  </div>
                  <div className="flex items-center">
